...
class CreatePoliticianPage extends FormHandler {
	...
	public function __construct() {
		...
		$this->errors = array(
			'last_name' => false,
                ...
                if(isset($_GET['localparty']) && is_numeric($_GET['localparty'])) {
                    $this->localparty = $_GET['localparty'];
                }
	...
	protected function action() {
		Dispatcher::header('/appointments/createParty/?localparty='.$this->localparty);
		//Dispatcher::header('/');
	}
