...
/** Handles AJAX calls to list categories bound to specific region level. */
class CategoryListPage {
	...
	public function processGet($get) {
		...
		if (!isset($get['id']) || !ctype_digit($get['id']) || !Dispatcher::inst()->user->loggedIn)
			$this->badRequest();
	...
	public function show($smarty) {
		...
		$categories = $category->listByRegion($this->region);
