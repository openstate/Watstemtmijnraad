...
class indexPage extends indexPageBase {
	...
	public function processGet($get) {
		if (!isset($_SESSION['role'])) {
			...
			try { //allows role selected by Politician, $get['id'] ignored, politician by role
				  //allows role selected by Party (Secretary) if party registered in region where at least one function is registered for politician $get['id']
				  //allwos role selected by Region (Clerk) if there is at least one function and party is registered in selected region
