<?php /* Smarty version 2.6.18, created on 2010-12-23 15:45:28
         compiled from /var/www/projects/watstemtmijnraad_hg/pages/admin/wizard/header/newPolitician.html */ ?>
...
window.addEvent(\'domready\', function() {
    ...
    if ($(\'delivery_date2\') && $(\'delivery_date2\').value == \'\') {
        $$(\'div.delivery_date2\').setStyle(\'display\', \'none\'); // Hide by default, if no value pre-defined (posted)
    }
    ...
    deliveryDate2 = new Calendar(
        { delivery_date2: \'d-m-Y\' },
        { blocked:  [\'0 * * 0,6\'],
          tweak : {x: 180, y: -150},
          days: [\'Zondag\', \'Mandag\', \'Dinsdag\', \'Woensdag\', \'Donderdag\', \'Vrijdag\', \'Zaterdag\'],
          months: [\'januari\', \'februari\', \'maart\', \'april\', \'mei\', \'juni\', \'juli\', \'augustus\', \'september\', \'oktober\', \'november\', \'december\']});
