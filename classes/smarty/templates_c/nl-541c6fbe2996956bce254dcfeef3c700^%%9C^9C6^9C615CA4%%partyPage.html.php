<?php /* Smarty version 2.6.18, created on 2010-12-10 08:35:53
         compiled from /var/www/projects/watstemtmijnraad_hg/pages/watstemtmijnraad/iframe/content/partyPage.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', '/var/www/projects/watstemtmijnraad_hg/pages/watstemtmijnraad/iframe/content/partyPage.html', 2, false),array('modifier', 'htmlentities', '/var/www/projects/watstemtmijnraad_hg/pages/watstemtmijnraad/iframe/content/partyPage.html', 30, false),array('modifier', 'strip_tags', '/var/www/projects/watstemtmijnraad_hg/pages/watstemtmijnraad/iframe/content/partyPage.html', 31, false),array('modifier', 'truncate', '/var/www/projects/watstemtmijnraad_hg/pages/watstemtmijnraad/iframe/content/partyPage.html', 31, false),)), $this); ?>
...
">
 ...
 raadstukken waarop <?php echo $this->_tpl_vars['party']->name; ?>
 heeft gestemd</p>
            </div>
...
?>
        	<li <?php if (($this->_foreach['radlist']['iteration'] <= 1)): ?>class="first"<?php endif; ?>>
        		<span class="pol_voted">
        			<?php if ($this->_tpl_vars['rad']->party_vote_0 != $this->_tpl_vars['rad']->party_vote_1): ?>
        				<?php if ($this->_tpl_vars['rad']->party_vote_0 > $this->_tpl_vars['rad']->party_vote_1): ?>Stemde <span class="pro">voor</span>
        				<?php else: ?>Stemde <span class="contra">tegen</span>
        				<?php endif; ?>
        			<?php else: ?><span class="abstain">Heeft zich onthouden</span>
        			<?php endif; ?>
        		</span>
