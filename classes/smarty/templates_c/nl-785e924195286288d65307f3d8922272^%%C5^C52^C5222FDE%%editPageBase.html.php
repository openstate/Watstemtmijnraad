<?php /* Smarty version 2.6.18, created on 2011-01-31 15:01:02
         compiled from /var/www/projects/watstemtmijnraad/public_html/../pages/admin/regions/php/../content//editPageBase.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'htmlentities', '/var/www/projects/watstemtmijnraad/public_html/../pages/admin/regions/php/../content//editPageBase.html', 8, false),array('function', 'html_options', '/var/www/projects/watstemtmijnraad/public_html/../pages/admin/regions/php/../content//editPageBase.html', 17, false),)), $this); ?>
<a name="RegionEdit"></a><form action="" name="RegionEdit" method="post" onsubmit="return formSubmit(this)" enctype="multipart/form-data">
...
" id="region_name" onkeyup="revalidate(this.form)" /> <span class="error" id="_err_region_name_0" style="<?php if (! $this->_tpl_vars['formerrors']['region_name_0']): ?>display:none<?php endif; ?>">Dit veld is verplicht</span></td>
        ...
        <tr>
				<th>Hidden</th>
				<td><input type="checkbox" name="hidden" value="1" <?php if ($this->_tpl_vars['formdata']['hidden']): ?>checked="checked"<?php endif; ?> /></td>
			</tr>
...
" id="level" /> <span class="error" id="_err_level_0" style="<?php if (! $this->_tpl_vars['formerrors']['level_0']): ?>display:none<?php endif; ?>">Dit veld is verplicht</span></td>
		...
		<tr>
				<td colspan="2" class="no-underline"><div class="container-buttons"><button class="submit" type="submit">Wijzigen</button></div></td>
			</tr>
			</table>
</form><script type="text/javascript"><!--
updateVisibility(document.forms['RegionEdit']) //--></script>