...
$l['mybb_admin_panel'] = "MyBB Beheerdersconfiguratiescherm";
$l['mybb_admin_cp'] = "MyBB BeheerdersCS";
$l['logged_in_as'] = "Aangemeld als";
$l['view_board'] = "Discussiebord bekijken";
$l['logout'] = "Afmelden";

// Footer language strings
$l['generated_in'] = "Aangemaakt in {1} seconden met {2} queries.";

// Login page
$l['enter_username_and_password'] = "Voer uw gebruikersnaam en wachtwoord in om verder te gaan.";
$l['mybb_admin_login'] = "MyBB BeheerdersCS - Aanmelden";
$l['return_to_forum'] = "Terug naar het discussiebord";
$l['please_login'] = "Aanmelden";
$l['username'] = "Gebruikersnaam:";
$l['password'] = "Wachtwoord:";
$l['login'] = "Aanmelden";
$l['lost_password'] = "Uw wachtwoord vergeten?";

$l['error_invalid_admin_session'] = "Ongeldige beheerdersessie.";
$l['error_admin_session_expired'] = "Uw beheerdersessie is verlopen.";
$l['error_invalid_ip'] = "Uw IP-adres is niet geldig voor deze beheerdersessie.";

$l['success_logged_out'] = "U hebt zich afgemeld.";
$l['error_invalid_username_password'] = "U hebt een ongeldige gebruikersnaam of ongeldig wachtwoord opgegeven.";

// Action Confirmation
$l['confirm_action'] = "Weet u zeker dat u deze handeling wilt uitvoeren?";
...
// Access Denied
$l['access_denied'] = "Toegang geweigerd";
$l['access_denied_desc'] = "U hebt geen toegang tot dit onderdeel van het beheerdersconfiguratiescherm.";

// Super Administrator required
$l['cannot_perform_action_super_admin_general'] = "U kunt deze handeling niet uitvoeren omdat u geen superbeheerder bent.<br /><br />Om deze handeling uit te kunnen voeren, moet u uw gebruikers-id toevoegen aan de lijst van superbeheerders in inc/config.php.";

// AJAX
$l['loading_text'] = "Bezig met laden<br />Een ogenblik geduld...";
...
$l['invalid_post_verify_key2'] = "e authorisatiecodes komen niet overeen. Controleer dat u deze pagina juist benadert.";
...
$l['editor_enter_list_item'] = "Voer een item in. Vul niets in of druk op Annuleren om de lijst te be&euml;indigen.";
